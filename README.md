...
ไฟล์อื่นๆ ที่เคยอยู่ใน ZIP เดิม (storage.js, firebase.js, firestore-sync.js, pwa-install.js, css/rebuild.css, โฟลเดอร์ js/, โฟลเดอร์ icon/) ไม่ได้ถูก import หรือเรียกใช้จากที่ไหนเลยในแอปที่รันจริง (index.html โหลดแค่ style.css กับ app.js) จึงถูกตัดออก เหลือเฉพาะไฟล์ที่ทำงานจริง
